  ...
  <body>
          ...
          <div class="col-lg-6 offset-lg-1">
            <div class="banner_text">
              <div class="banner_text_iner">
                ...
                <h1>Arzy Studio</h1>
                <a href="#" class="btn_1">Software Developer</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="filters-content">
          <div class="row justify-content-between portfolio-grid">
            <div class="col-lg-4 col-sm-4 all buildings" style="margin-bottom:10px;">
            ...
            <div class="col-lg-4 col-sm-4 all rebuild" style="margin-bottom:10px;">
              <div class="single_our_project">
                <div class="single_offer">
            ...
            <div class="col-lg-4 col-sm-4 all buildings">
                <div class="single_our_project">
                  <div class="single_offer">
                    <img src="img/project_1.png" alt="offer_img_1" />
    ...
    <section class="creative padding_bottom">
      <div class="container-fluid">
        <div class="row align-item  s-center justify-content-start">
